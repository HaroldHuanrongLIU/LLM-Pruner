...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description='Pruning Qwen2 models')

    # argument for parsing
    parser.add_argument('--base_model', type=str, default="Qwen/Qwen2.5-7B", help='base model name')
    ...
    parser.add_argument('--block_attention_layer_start', type=int, help='start layer of block attention layers', default=4)
    parser.add_argument('--block_attention_layer_end', type=int, help='end layer of block attention layers', default=27)
    parser.add_argument('--block_mlp_layer_start', type=int, help='start layer of block mlp layers', default=4)
    parser.add_argument('--block_mlp_layer_end', type=int, help='end layer of block mlp layers', default=27)
